...
export default function DetailedResult({
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-lg border border-slate-200/60 overflow-hidden">
      {/* Header */}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100">Review your incorrect answers</p>
            </div>
          </div>
      ...
      <div className="p-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8 pt-6 border-t border-slate-200">
          <Button
            ...
            className="bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 rounded-xl font-medium px-6 py-3"
          >
            Back to Score
          </Button>
          ...
          <Button
            ...
            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-medium px-6 py-3"
          >
            Take Another Exam
          </Button>
        </div>
