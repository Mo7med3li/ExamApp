...
export default function QuestionForm({ questions }: QuestionsFormProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-blue-100 rounded-2xl border border-slate-200/60 overflow-hidden">
      {/* Header */}
                    ...
                    >
                      {currentQuestion?.answers.map((answerOption, index) => (
                        <FormItem key={answerOption.key}>
                          <div className="group">
                            <div className="flex items-center space-x-4 p-5 rounded-2xl border-2 border-slate-200 bg-white hover:border-blue-300 hover:bg-blue-50/50 transition-all duration-200 cursor-pointer">
                              <FormControl>
                                <RadioGroupItem
